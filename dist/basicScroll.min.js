...
},{"base64-js":1,"ieee754":39,"isarray":40}],3:[function(require,module,exports){
'use strict';
...
},{"./polyfill":6,"buffer":2}],5:[function(require,module,exports){
'use strict';
...
},{"./copy":4,"./polyfill":6}],6:[function(require,module,exports){
(function (Buffer){
'use strict';
...
var validate = function validate() {
	...
	data = (0, _deepcopy2.default)(data);
	...
	forEachProp(data.props, function (prop) {
...
var update = function update(data) {
	...
	// Update each value
	forEachProp(data.props, function (prop, key) {
		...
		var time = prop.timing(percentage / 100);
...
var loop = function loop(style, previousScrollTop) {
	...
	var newProps = activeInstances.map(function (instance) {
		return update(instance.getData(), scrollTop);
	});
...
},{"deepcopy":3,"eases":25,"parse-unit":41}]},{},[42])(42)
});